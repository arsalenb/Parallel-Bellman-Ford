...
int flag = 1; // Indicates if any vertex was updated in the current iteration
int * mask, * mask1; // Active vertices for the current and next iteration

int ** m; // Adjacency matrix for the graph (edge weights)
int * d, * d_local; // Distance arrays (global and local)
